    ...
    <div className="pt-20">
      ...
      <section className="py-20 bg-gradient-to-br from-green-50 to-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h1 className="text-5xl font-bold mb-6 bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent" style={{lineHeight: '1.2', paddingBottom: '8px'}}>
            General Inquiry
          </h1>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-2">For general inquiries and information</p>
                    <a href="mailto:info@varahi.com" className="text-blue-600 hover:text-blue-700 font-medium">
                      info@varahi.com
                    </a>
                  </div>
                </div>
